...
def remove_codec_weight_norm(model):
    ...
    from academicodec.modules.seanet0 import SConvTranspose1d
    from academicodec.modules.seanet0 import SEANetResnetBlock
...
def test_batch():
    ...
    remove_codec_weight_norm(soundstream)
    soundstream.cuda()
    soundstream.eval()
