...
from academicodec.models.tcm.dataset import NSynthDataset
from academicodec.models.tcm.loss import criterion_d
from academicodec.models.tcm.loss import criterion_g
from academicodec.models.tcm.loss import loss_dis
from academicodec.models.tcm.loss import loss_g
from academicodec.models.tcm.msstftd import MultiScaleSTFTDiscriminator
...
def main_worker(local_rank, args):
    ...
    if args.resume:
        latest_info = torch.load(args.resume_path + '/best_29.pth')
